    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 align-self-center p-static order-2 text-center">
                ...
                <h1 class="text-dark font-weight-bold text-8">ARSIP BERITA</h1>
                <span class="sub-title text-dark">{{ $pegawai["nama_skpd"] }}</span>
            </div>
            ...
            <div class="col-md-12 align-self-center order-1">
                ...
                <ul class="breadcrumb d-block text-center">
                    ...
                    <li class="active">ARSIP BERITA {{ $pegawai["nama_skpd"] }}</li>
                </ul>
            </div>
        </div>
    </div>
										...
										<div class="col-lg-5">
											<div class="post-image">
												<a href="blog-post.html">
													<img src="{{ URL::to($item->picture) }}" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" alt="" />
												</a>
											</div>
										</div>
										<div class="col-lg-7">
