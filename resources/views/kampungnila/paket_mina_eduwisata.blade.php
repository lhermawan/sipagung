        ...
        <div class="row">
            ...
            <h2 class="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
									...
									<span class="word-rotator-words bg-primary">
										<b class="is-visible">PAKET MINA EDUWISATA</b>
    ...
    <div id="revolutionSliderCarousel" class="rev_slider fullwidthabanner" data-version="5.4.8">
        ...
        @foreach ($paket as $key => $item)
            <li data-index="rs-1" data-transition="fade" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="" data-description="">
                <img src="{{ URL::to($item->picture) }}" alt="{{$item->jenis_paket}}" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
            </li>
         @endforeach
        </ul>
                ...
                <div class="container py-4">
					<h4 class="mb-3 text-4 text-uppercase">Semua Jenis Paket <strong class="font-weight-extra-bold">Eduwisata Kampung Nila</strong></h4>
					<div class="row">
                        @foreach ($paket as $key => $item)
						<div class="col-12 col-sm-6 col-lg-3 mb-4">
							<div class="portfolio-item">
								<a href="{{ url('kampungnila/detail_paket_mina_eduwisata/'.$item->title_slug) }}">
									<span class="thumb-info thumb-info-lighten thumb-info-no-borders border-radius-0">
										<span class="thumb-info-wrapper border-radius-0">
											<img src="{{ URL::to($item->picture) }}" width="300px" height="200px" alt="">
											<span class="thumb-info-title">
												<span class="thumb-info-inner">{{$item->jenis_paket}}</span>
												<span class="thumb-info-type">Jenis Paket</span>
											</span>
