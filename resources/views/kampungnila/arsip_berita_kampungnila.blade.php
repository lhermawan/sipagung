    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 align-self-center p-static order-2 text-center">
                ...
                <h1 class="text-dark font-weight-bold text-8">ARSIP BERITA SFV KAMPUNG NILA</h1>
            ...
            <div class="col-md-12 align-self-center order-1">
                ...
                <ul class="breadcrumb d-block text-center">
                    ...
                    <li class="active">ARSIP BERITA SFV KAMPUNG NILA {{ $pegawai["nama_skpd"] }}</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-pane" id="recentPosts">
                        ...
                        @foreach ($archive as $key => $arsip)
                            <li>
                                <div class="post-image">
                                    <div class="img-thumbnail img-thumbnail-no-borders d-block">
                                        <a href="{{ url('kampungnila/arsip_berita_kampungnila/'.$arsip['month'], $arsip['year']) }}">
                                            <img src="{{URL::to('images/ilmu-arsip.jpeg') }}" width="50" height="50" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="post-info">
                                    <a href="{{ url('kampungnila/arsip_berita_kampungnila/'.$arsip['month'], $arsip['year']) }}">{{$arsip['month']}} {{$arsip['year']}}</a>
                                    <div class="post-meta">
									...
									<div class="row">
										<div class="col">
											<div class="post-meta">
												...
												<span class="d-block d-sm-inline-block float-sm-right mt-3 mt-sm-0"><a href="{{ url('berita_kampungnila/detail_berita_kampungnila/'.$item->title_slug) }}" class="btn btn-xs btn-light text-1 text-uppercase">Baca Selengkapnya</a></span>
											</div>
										</div>
									</div>
								</article>
