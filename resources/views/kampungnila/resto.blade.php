        ...
        <div class="row">
            ...
            <div class="col-md-12 align-self-center order-1">
                ...
                <ul class="breadcrumb d-block text-center">
                    ...
                    <li class="active">Resto Kampung Nila</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        @foreach ($data as $key => $item)
         ...
         @endforeach
                ...
                <div class="container py-4">
					<h4 class="mb-3 text-4 text-uppercase">Semua Resto <strong class="font-weight-extra-bold"> Kampung Nila</strong></h4>
					<div class="row">
                        @foreach ($data as $key => $item)
						<div class="col-12 col-sm-6 col-lg-3 mb-4">
							<div class="portfolio-item">
								<a href="{{ url('kampungnila/detail_resto/'.$item->title_slug) }}" target="_BLANK">
									<span class="thumb-info thumb-info-lighten thumb-info-no-borders border-radius-0">
										<span class="thumb-info-wrapper border-radius-0">
											<img src="{{ URL::to($item->picture) }}" width="300px" height="200px" alt="">
											<span class="thumb-info-title">
												<span class="thumb-info-inner">{{$item->jenis_resto}}</span>
												<span class="thumb-info-type">Resto</span>
											</span>
