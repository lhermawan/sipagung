...
<html>
	<head>
		...
		<meta name="description" content="DETAIL PAKET MINA EDUWISATA SFV KAMPUNG NILA {{ $pegawai['nama_skpd'] }} ">
...
{{-- <span class="sub-title text-dark">Check out our Latest News!</span> --}}
                ...
                <div class="col-md-12 align-self-center order-1">
                    ...
                    <ul class="breadcrumb d-block text-center">
                        ...
                        <li class="">Detail Pokdakan Kampung Nila {{ $pegawai["nama_skpd"] }}</li>
						...
						<div class="col">
                            ...
                            <div class="card">
								...
								<article class="post post-large blog-single-post border-0 m-0 p-0">
										...
										<center><a class="img-thumbnail d-block lightbox" href="{{ URL::to($data->picture) }}" data-plugin-options="{'type':'image'}">
											<img src="{{ URL::to($data->picture) }}" class="img-fluid img-thumbnail img-thumbnail-no-borders rounded-0" style="width:50%;height:50%"alt="" />
										</a></center>
									</div>
									...
									<div class="post-content ml-0">
										...
										<div class="post-block mt-5 post-share">
											...
											<h5 class="mb-3">Share Pokdakan Kampung Nila</h5><br>
													{!! $shareComponent !!}
											</div>
