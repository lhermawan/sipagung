        ...
        <div class="row">
            ...
            <h2 class="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
									...
									<span class="word-rotator-words bg-primary">
										<b class="is-visible">MINAEDUWISATA</b>
            ...
            <div class="col-md-12 align-self-center order-1">
                ...
                <ul class="breadcrumb d-block text-center">
                    ...
                    <li class="active">MINAEDUWISATA</li>
                </ul>
            </div>
        </div>
    </div>
									...
									<div class="row mb-3">
										<div class="col-lg-5">
											<div class="post-image">
												<a href="{{ url('kampungnila/detail_minaeduwisata/'.$item->title_slug) }}">
										...
										<span class="d-block d-sm-inline-block float-sm-right mt-3 mt-sm-0"><a href="{{ url('kampungnila/detail_minaeduwisata/'.$item->title_slug) }}" class="btn btn-xs btn-light text-1 text-uppercase">Baca Selengkapnya</a></span>
									</div>
								</article>
            @endforeach
