        ...
        <div class="row">
            ...
            <h2 class="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
									...
									<span class="word-rotator-words bg-primary">
										<b class="is-visible">Kolam Pemancingan Lembah Ereng</b>
            ...
            <div class="col-md-12 align-self-center order-1">
                ...
                <ul class="breadcrumb d-block text-center">
                    ...
                    <li class="active">KOLAM PEMACINGAN LEMBAH ERENG</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="row py-4 mb-2">
        ...
        <div class="col-md-7 order-2">
            <div class="overflow-hidden">
                <h2 class="text-color-dark font-weight-bold text-8 mb-0 pt-0 mt-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="300">Kolam Pemancingan Lembah Ereng</h2>
            </div>
            <div class="overflow-hidden mb-3">
                <p class="font-weight-bold text-uppercase mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="500">Kolam Pemancingan</p>
            </div>
									...
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
                                        ...
                                        <img src="{{ URL::to('kampungnila/nila_mart.png') }}" height="200" width="50" alt="">
											<span class="thumb-info-title">
												...
												<span class="thumb-info-slide-info-hover-2">
													<span class="thumb-info-inner text-2">
														<a href="#" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-4 btn-py-2 text-1 rounded">Nila Mart <i class="fa fa-arrow-right ml-2 pl-1 text-3"></i></a>
													</span>
												</span>
											</span>
										</span>
									...
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
										<span class="thumb-info-wrapper thumb-info-wrapper-no-opacity">
											...
											<span class="thumb-info-title">
												...
												<span class="thumb-info-slide-info-hover-2">
													<span class="thumb-info-inner text-2">
														<a href="#" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-4 btn-py-2 text-1 rounded">Mina Eduwisata <i class="fa fa-arrow-right ml-2 pl-1 text-3"></i></a>
													</span>
												</span>
											</span>
										</span>
									...
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
                                        ...
                                        <img src="{{ URL::to('kampungnila/nila_budidaya.png') }}" height="200" width="50" alt="">
											<span class="thumb-info-title">
												...
												<span class="thumb-info-slide-info-hover-2">
													<span class="thumb-info-inner text-2">
														<a href="#" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-4 btn-py-2 text-1 rounded">Budi Daya Ikan <i class="fa fa-arrow-right ml-2 pl-1 text-3"></i></a>
													</span>
												</span>
											</span>
										</span>
									...
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
                                        ...
                                        <img src="{{ URL::to('kampungnila/nila_pengolahan.png') }}" height="200" width="50" alt="">
											<span class="thumb-info-title">
												...
												<span class="thumb-info-slide-info-hover-2">
													<span class="thumb-info-inner text-2">
														<a href="#" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-4 btn-py-2 text-1 rounded">Pengolahan Ikan <i class="fa fa-arrow-right ml-2 pl-1 text-3"></i></a>
													</span>
												</span>
											</span>
										</span>
									...
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
                                        ...
                                        <img src="{{ URL::to('kampungnila/nila_resto.png') }}" height="200" width="50" alt="">
											<span class="thumb-info-title">
												...
												<span class="thumb-info-slide-info-hover-2">
													<span class="thumb-info-inner text-2">
														<a href="#" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-4 btn-py-2 text-1 rounded">Resto <i class="fa fa-arrow-right ml-2 pl-1 text-3"></i></a>
													</span>
												</span>
											</span>
										</span>
									...
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
                                        ...
                                        <img src="{{ URL::to('kampungnila/nila_fishing.png') }}" height="200" width="50" alt="">
											<span class="thumb-info-title">
												...
												<span class="thumb-info-slide-info-hover-2">
													<span class="thumb-info-inner text-2">
														<a href="{{ URL::to('kampungnila/kolam_pemancingan_lembah_ereng') }}" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-4 btn-py-2 text-1 rounded">Kolam Pemancingan Lembah Ereng<i class="fa fa-arrow-right ml-2 pl-1 text-3"></i></a>
													</span>
												</span>
											</span>
										</span>
									...
									<span class="thumb-info thumb-info-no-borders thumb-info-no-borders-rounded thumb-info-centered-info thumb-info-no-zoom thumb-info-slide-info-hover">
										<span class="thumb-info-wrapper thumb-info-wrapper-no-opacity">
											...
											<span class="thumb-info-title">
												...
												<span class="thumb-info-slide-info-hover-2">
													<span class="thumb-info-inner text-2">
														<a href="{{ URL::to('kampungnila/pasar_kertamanggala') }}" class="d-inline-flex align-items-center btn btn-light text-color-dark font-weight-bold px-4 btn-py-2 text-1 rounded">Pasar Ikan Kertamanggala <i class="fa fa-arrow-right ml-2 pl-1 text-3"></i></a>
													</span>
												</span>
											</span>
										</span>
