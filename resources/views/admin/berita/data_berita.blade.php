                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Data Berita PORPROV XIV</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href=""></a></li>
									<li class="breadcrumb-item active">Berita PORPROV XIV</li>
								</ul>
							</div>
							<div class="col-auto float-right ml-auto">
                            <a href="{{ route('admin/berita/tambah_berita') }}" class="btn add-btn"><i class="fa fa-plus"></i> Tambah Berita</a>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td>
                                            <a class="thumbnail" href="#"> <img class="img-responsive" src="{{ URL::to('/images/berita/'. $item->avatar) }}" alt="{{ $item->title }}" width="10%" height="20%"></a>
                                            ...
                                            <td>
                                            <a type="button" class="btn btn-info" target="_BLANK" href="{{ url('news/detail_news/'.$item->title_slug) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a>
                                            </td>
                                            
                        
											<td class="text-right">
                                            <a type="button" class="btn btn-warning"  href="{{ url('admin/berita/edit_berita/'.$item->id_berita) }}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
...
<div class="modal fade" id="hapus_berita" tabindex="-1" aria-labelledby="modalkdp" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('deleteberita') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('DELETE')}}
