...
<div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Edit Skor Pertandingan BMX</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html"></a>Dashboard</li>
									<li class="breadcrumb-item active">Edit Skor Pertandingan BMX</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title mb-0">Edit Skor Pertandingan BMX</h4>
								</div>
								<div class="card-body">
                                <form class="form form-horizontal" action="{{ route('updateSkorPertandinganBMX') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control @error('id_series_bmx') is-invalid @enderror" readonly name="id_series_bmx" value="{{$data3[0]->id_series_bmx}}" type="hidden" id="id_pertandingan_tenis_meja" required>
