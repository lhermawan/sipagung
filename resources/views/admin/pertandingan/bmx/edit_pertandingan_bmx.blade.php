...
<div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Edit Pertandingan BMX</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html"></a>Dashboard</li>
									<li class="breadcrumb-item active">Pertandingan BMX</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title mb-0">Edit Pertandingan BMX</h4>
								</div>
								<div class="card-body">
                                <form class="form form-horizontal" action="{{ route('updatePertandinganBMX') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
   
                               
                                        <input class="form-control @error('id_series_bmx') is-invalid @enderror" readonly name="id_series_bmx" value="{{$data[0]->id_series_bmx}}" type="hidden" id="id_series_bmx" required>
                                        ...
                                        <label class="col-sm-2 col-form-label">Judul Series</label>
                                            <div class="col-sm-10">
                                                <input class="form-control @error('	nama_series_bmx') is-invalid @enderror" name="nama_series_bmx" value="{{$data[0]->nama_series_bmx}}" type="text" id="waktu" placeholder="" required>
                                                @error('waktu')
                                            ...
                                            <div class="col-sm-10">
                                                        <input type="file" class="form-control"
                                                            ...
                                                            <div class="d-flex mr-3 rounded-circle thumb-md">
                                                                <img class="d-flex mr-3 rounded-circle thumb-md" width="100" height="100" src="{{ URL::to('/images/bmx/'. $data[0]->avatar) }}">
                                                            </div>
