					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
                                <form class="form form-horizontal" action="{{ route('updatePertandinganTenisGandaCampuran') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group col-md-6">
                                               ...
                                               <select name="id_atlit1a_tenis_meja" class="form-control" id="id_atlit1a_tenis_meja">
                                                    <option value="{{ $data[0]->id_atlit1a_tenis_meja}}" selected>--Pilihan Sebelumnya ( {{ $data[0]->atlit1a->nama_atlit}} / {{ $data[0]->atlit1a->data_peserta->asal_kabkota}})--</option>

                                                @foreach ($data3 as $peser => $item)
                                                        @if($item->jenis_kelamin == "Wanita")
                                                            <option id="id_atlit1a_tenis_meja" value="{{$item->id_atlit}}">{{$item->nama_atlit}} ( {{ $item->asal_kabkota}} )</option>
                                                        @endif
                                                    @endforeach 
                                                    </select>
                                            ...
                                            <label for="inputPassword4">Peserta Wanita Team 2</label>
                                                    <select name="id_atlit2a_tenis_meja" class="form-control" id="id_atlit2a_tenis_meja">
                                                    <option value="{{ $data[0]->id_atlit2a_tenis_meja}}" selected>--Pilihan Sebelumnya ( {{ $data[0]->atlit2a->nama_atlit}} / {{ $data[0]->atlit2a->data_peserta->asal_kabkota}})--</option>

                                                @foreach ($data3 as $peser => $item)
                                                        @if ($item->jenis_kelamin == "Wanita")
                                                            <option id="id_atlit2a_tenis_meja" value="{{$item->id_atlit}}">{{$item->nama_atlit}} ( {{ $item->asal_kabkota}} )</option>
                                                        @endif
                                                    @endforeach 
                                                    </select>
