...
{{-- message --}}
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
                            ...
                            <button type="button" data-idcabor2="{{$data2[0]->id_jenis_cabor2}}" class="btn add-btn" data-toggle="modal" data-target="#add_wushu" style="float: right;"><i class="bi bi-plus-lg"></i> Input Jadwal Pertandingan</button>
							</div>
						</div>
					</div>
	...
	<div class="col-sm-6 col-md-1">  
		<button type="submit" class="btn btn-success btn-block"> Cari </a></button>
                        ...
                        <div class="col-sm-6 col-md-2">  
                            <a href="{{ url('admin/pertandingan/wushu/detail_pertandingan_wushu/'.$data2[0]->id_jenis_cabor2) }}" button type="submit" class="btn btn-info btn-block"> Refresh </a></button>
                        </div>   
                                    ...
                                    @foreach ($wushu as $key => $item)
                                        <tr>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ url('admin/pertandingan/wushu/edit_pertandingan_wushu/'.$item->id_pertandingan_wushu) }}"><i class="fa fa-edit-o m-r-5"></i> Edit Data</a>
                                                <a class="dropdown-item" data-id="{{$item->id_pertandingan_wushu}}" data-skor1="{{$item->skor_peserta1}}" data-skor2="{{$item->skor_peserta2}}"  data-status="{{$item->status_pertandingan}}"  class="btn add-btn" data-toggle="modal" data-target="#edit_skor" style="float: right;"><i class="fa fa-pencil-o m-r-5"></i> Edit Skor</a>
												<a class="dropdown-item" data-id="{{$item->id_pertandingan_wushu}}" class="btn add-btn" data-toggle="modal" data-target="#hapus_wushu" style="float: right;"><i class="fa fa-trash-o m-r-5"></i> Hapus</a>
                                            </td>
                                                </div>
                                                </div>
										    </tr>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($wushu2 as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{$item->wushu_menang->nama_atlit }}</td>
                                            <td>{{$item->wushu_kalah->nama_atlit }}</td>
...
<div class="modal fade" role="dialog" id="imgmodal">
    ...
    <div class="modal fade" id="add_wushu" tabindex="-1" aria-labelledby="modalkdp" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalkdp">Tambah Jadwal Pertandingan Wushu {{$data2[0]->nama_jenis_cabor}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </div>
            <div class="modal-body">
            <form action="{{ route('saveWushu') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="hapus_wushu" tabindex="-1" aria-labelledby="modalkdp" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalkdp">Hapus Jadwal Pertandingan Wushu {{$data2[0]->nama_jenis_cabor}} tersebut?</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </div>
            <div class="modal-body">
            <form action="{{ route('deleteJadwalWushu') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('DELETE')}}
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="id_pertandingan_wushu" name="id_pertandingan_wushu" readonly required>
                    </div>
...
<div class="modal fade" id="edit_skor" tabindex="-1" aria-labelledby="modalkdp" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <form action="{{ route('updateSkorPertandinganWushuSingle') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    
                <input type="hidden" readonly class="form-control" id="id_pertandingan_wushu" name="id_pertandingan_wushu" readonly>
...
// })
$('#add_wushu').on('show.bs.modal', function (event) {
...
var modal = $(this)
modal.find('.modal-body #id_pertandingan_wushu').val(ID)
...
$('#hapus_wushu').on('show.bs.modal', function (event) {
