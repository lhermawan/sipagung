...
<div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Edit Skor Pertandingan Wushu</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html"></a>Dashboard</li>
									<li class="breadcrumb-item active">Edit Skor Pertandingan Wushu</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title mb-0">Edit Skor Pertandingan Wushu</h4>
								</div>
								<div class="card-body">
                                <form class="form form-horizontal" action="{{ route('updateSkorPertandinganWushu') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control @error('id_pertandingan_wushu') is-invalid @enderror" readonly name="id_pertandingan_wushu" value="{{$data3[0]->id_pertandingan_wushu}}" type="hidden" id="id_pertandingan_wushu" required>
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div id="no1" class="form-group col-md-6" style="display:none">
                                                <label for="inputEmail4">Pemenang Ke 1</label>
                                                    <select name="team_menang1" class="form-control" id="team_menang1">
                                                    <option value="">--Pilih Pemenang--</option>

                                                @foreach ($data3 as $peser => $item)
                                                            <option id="team_menang1" value="{{$item->id_data_peserta }}">{{ $item->asal_kabkota}}</option>
                                                    @endforeach 
                                                    </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div id="no3" class="form-group col-md-6" style="display:none">
                                                <label for="inputEmail4">Pemenang Ke 2</label>
                                                    ...
                                                    <select name="team_menang2" class="form-control" id="team_menang2">
                                                    <option value="">--Pilih Pemenang--</option>

                                                @foreach ($data3 as $peser => $item)
                                                            <option id="team_menang2" value="{{$item->id_data_peserta }}">{{ $item->asal_kabkota}}</option>
                                                    @endforeach 
                                                    </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div id="no5" class="form-group col-md-6" style="display:none">
                                                <label for="inputEmail4">Pemenang Ke 3</label>
                                                    ...
                                                    <select name="team_menang3" class="form-control" id="team_menang3">
                                                    <option value="">--Pilih Pemenang--</option>

                                                @foreach ($data3 as $peser => $item)
                                                            <option id="team_menang3" value="{{$item->id_data_peserta }}"> {{ $item->asal_kabkota}}</option>
                                                    @endforeach 
                                                    </select>
