...
<div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Edit Pertandingan Wushu</h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="index.html"></a>Dashboard</li>
									<li class="breadcrumb-item active">Pertandingan Wushu</li>
								</ul>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title mb-0">Edit Pertandingan Wushu</h4>
								</div>
								<div class="card-body">
                                <form class="form form-horizontal" action="{{ route('updatePertandinganWushu') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
   
                                        <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Peserta 1</label>
                                            <div class="col-sm-10">
                                                <input class="form-control @error('id_pertandingan_wushu') is-invalid @enderror" readonly name="id_pertandingan_wushu" value="{{$data[0]->id_pertandingan_wushu}}" type="hidden" id="id_pertandingan_wushu" required>
                                            ...
                                            <div class="col-sm-10">
                                                        <input type="file" class="form-control"
                                                            ...
                                                            <div class="d-flex mr-3 rounded-circle thumb-md">
                                                                <img class="d-flex mr-3 rounded-circle thumb-md" width="100" height="100" src="{{ URL::to('/images/wushu/'. $data[0]->avatar) }}">
                                                            </div>
