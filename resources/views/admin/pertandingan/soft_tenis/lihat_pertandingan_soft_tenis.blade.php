								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data1 as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td><a type="button" class="btn btn-info"  href="{{ url('admin/pertandingan/soft_tenis/detail_pertandingan_soft_tenis_single/'.$item->id_jenis_cabor2) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a></td>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data3 as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td><a type="button" class="btn btn-info"  href="{{ url('admin/pertandingan/soft_tenis/detail_pertandingan_soft_tenis_ganda_campuran/'.$item->id_jenis_cabor2) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a></td>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data4 as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td><a type="button" class="btn btn-info"  href="{{ url('admin/pertandingan/soft_tenis/detail_pertandingan_soft_tenis_ganda/'.$item->id_jenis_cabor2) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a></td>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data6 as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td><a type="button" class="btn btn-info"  href="{{ url('admin/pertandingan/soft_tenis/detail_pertandingan_beregu_putra/'.$item->id_jenis_cabor2) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a></td>
