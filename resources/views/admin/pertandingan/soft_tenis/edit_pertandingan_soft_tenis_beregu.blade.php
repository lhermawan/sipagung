					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
                                <form class="form form-horizontal" action="{{ route('updatePertandinganSoftTenisBeregu') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <label class="col-sm-2 col-form-label">Peserta 1</label>
                                            <div class="col-sm-10">
                                                ...
                                                <select name="tim1" class="form-control" id="tim1">
                                                <option value="{{ $data[0]->tim1}}" selected>--Pilihan Sebelumnya ( {{ $data[0]->peserta_tim1->asal_kabkota}})--</option>
                                        ...
                                        <label class="col-sm-2 col-form-label">Peserta 2</label>
                                            <div class="col-sm-10">
                                            <select name="tim2" class="form-control" id="tim2">
                                                    <option value="{{ $data[0]->tim2}}" selected>--Pilihan Sebelumnya ( {{ $data[0]->peserta_tim2->asal_kabkota}})--</option>
