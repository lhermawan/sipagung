					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
                                <form class="form form-horizontal" action="{{ route('updatePertandinganSoftTenisSingle') }}" method="POST" enctype="multipart/form-data">
                                        @csrf

                                        <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Peserta 1</label>
                                            <div class="col-sm-10">
                                                <input class="form-control @error('id_pertandingan_soft_tenis') is-invalid @enderror" readonly name="id_pertandingan_soft_tenis" value="{{$data[0]->id_pertandingan_soft_tenis}}" type="hidden" id="id_pertandingan_soft_tenis" required>
