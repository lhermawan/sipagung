								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data1 as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td><a type="button" class="btn btn-info"  href="{{ url('admin/pertandingan/muaythai/detail_pertandingan_muaythai/'.$item->id_jenis_cabor2) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a></td>
