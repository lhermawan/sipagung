...
{{-- message --}}
	...
	<div class="col-sm-6 col-md-1">  
		<button type="submit" class="btn btn-success btn-block"> Cari </a></button>
                        ...
                        <div class="col-sm-6 col-md-2">  
                            <a href="{{ url('admin/pertandingan/atletik/detail_pertandingan_atletik/'.$data2[0]->id_jenis_cabor2) }}" button type="submit" class="btn btn-info btn-block"> Refresh </a></button>
                        </div>   
                                    ...
                                    @foreach ($atletik as $key => $item)
                                        <tr>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item" href="{{ url('admin/pertandingan/atletik/edit_skor_pertandingan_atletik/'.$item->id_series_atletik) }}"><i class="fa fa-edit-o m-r-5"></i> Edit Skor</a>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($atletik2 as $key => $item)
                                        <tr>
                                            ...
                                            @if(empty($item->id_peserta_menang_atletik1 == ""))
                                            <td><span class="badge bg-success" style="font-size: 16px;">{{$item->atletik_menang1->nama_atlit }} ( Skor {{$item->skor_pemenang1 }})</span></td>
                                            @else
                                            <td>TIDAK ADA</p>
                                            @endif

                                            @if(empty($item->id_peserta_menang_atletik2 == ""))
                                            <td><span class="badge bg-info" style="font-size: 16px;">{{$item->atletik_menang2->nama_atlit }} ( Skor {{$item->skor_pemenang2 }})</span></td>
                                            @else  
                                            <td>TIDAK ADA</p>
                                            @endif

                                            @if(empty($item->id_peserta_menang_atletik3 == ""))
                                            <td><span class="badge bg-danger" style="font-size: 16px;">{{$item->atletik_menang3->nama_atlit }} (Skor {{$item->skor_pemenang3 }})</span></td>
                                            @else
                                            <td>TIDAK ADA</p>
                                            @endif
