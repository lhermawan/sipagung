								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($pentaque as $key => $item)
                                        <tr>
											<td>{{ ++$key }}</td>
                                            @if(empty($item->team1 == ""))
                                            <td><span class="badge bg-danger" style="font-size: 16px;">{{$item->peserta_tim1->asal_kabkota }}</span></td>
                                            @else
                                            <td>TIDAK ADA</p>
                                            @endif
                                            ...
                                            <td>VS</td>
        									 @if(empty($item->team2 == ""))
                                            <td><span class="badge bg-danger" style="font-size: 16px;">{{$item->peserta_tim2->asal_kabkota }}</span></td>
                                            @else
                                            <td>TIDAK ADA</p>
                                            @endif
