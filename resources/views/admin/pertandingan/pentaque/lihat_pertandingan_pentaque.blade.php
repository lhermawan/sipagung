                    ...
                    <div class="card">
						<div class="card-body">
							...
							<ul class="nav nav-tabs nav-tabs-solid nav-justified">
								...
								<li class="nav-item"><a class="nav-link" href="#ganda_campuran" data-toggle="tab">Double Campuran</a></li>
								<li class="nav-item"><a class="nav-link" href="#ganda_putra" data-toggle="tab">Double Putra</a></li>
								<li class="nav-item"><a class="nav-link" href="#ganda_putri" data-toggle="tab">Double Putri</a></li>
								<li class="nav-item"><a class="nav-link" href="#triple" data-toggle="tab">Triple</a></li>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data1 as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td><a type="button" class="btn btn-info"  href="{{ url('admin/pertandingan/pentaque/detail_pertandingan_pentaque_single/'.$item->id_jenis_cabor2) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a></td>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data3 as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td><a type="button" class="btn btn-info"  href="{{ url('admin/pertandingan/pentaque/detail_pertandingan_pentaque_ganda_campuran/'.$item->id_jenis_cabor2) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a></td>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data4 as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td><a type="button" class="btn btn-info"  href="{{ url('admin/pertandingan/pentaque/detail_pertandingan_pentaque_ganda/'.$item->id_jenis_cabor2) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a></td>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($data6 as $key => $item)
                                        ...
                                        <td>{{ ++$key }}</td>
                                            ...
                                            <td><a type="button" class="btn btn-info"  href="{{ url('admin/pertandingan/pentaque/detail_pertandingan_pentaque_triple/'.$item->id_jenis_cabor2) }}"><i class="fa fa-eye m-r-5"></i> Lihat</a></td>
