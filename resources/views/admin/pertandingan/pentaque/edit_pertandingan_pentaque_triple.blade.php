					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								...
								<div class="card-body">
                                <form class="form form-horizontal" action="{{ route('updatePertandinganPentaqueGanda') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input class="form-control @error('id_pertandingan_pentaque') is-invalid @enderror" readonly name="id_pertandingan_pentaque" value="{{$data[0]->id_pertandingan_pentaque}}" type="hidden" id="id_pertandingan_tenis_meja" required>
                                                <input class="form-control @error('id_jenis_cabor2') is-invalid @enderror" readonly name="id_jenis_cabor2" value="{{$data[0]->id_jenis_cabor2}}" type="hidden" id="id_jenis_cabor2" required>
                                                    ...
                                                    <option value="{{ $data[0]->team1}}" selected>--Pilihan Sebelumnya ( {{ $data[0]->peserta_tim1->asal_kabkota}})--</option>
                                            ...
                                            <select name="team2" class="form-control" id="team2">
                                                    <option value="{{ $data[0]->team2}}" selected>--Pilihan Sebelumnya ( {{ $data[0]->peserta_tim2->asal_kabkota}})--</option>
