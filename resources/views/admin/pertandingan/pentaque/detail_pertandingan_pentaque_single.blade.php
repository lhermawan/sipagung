								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($pentaque as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                            <a type="button" class="btn btn-success"  href="{{ url('admin/pertandingan/pentaque/lihat_peserta_pentaque/'.$item->id_pertandingan_pentaque) }}"><i class="fa fa-users m-r-5"></i> Lihat Peserta</a>
                                            </td>
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ url('admin/pertandingan/pentaque/edit_pertandingan_pentaque_single/'.$item->id_pertandingan_pentaque) }}"><i class="fa fa-edit-o m-r-5"></i> Edit Data</a>
                                                <a class="dropdown-item" href="{{ url('admin/pertandingan/pentaque/edit_skor_pertandingan_pentaque/'.$item->id_pertandingan_pentaque) }}"><i class="fa fa-edit-o m-r-5"></i> Edit Skor</a>
												<a class="dropdown-item" data-id="{{$item->id_pertandingan_pentaque}}" class="btn add-btn" data-toggle="modal" data-target="#hapus_bmx" style="float: right;"><i class="fa fa-trash-o m-r-5"></i> Hapus</a>
                                            </td>
                                                </div>
                                                </div>
										    </tr>
								...
								<table class="table table-striped custom-table datatable">
                                    ...
                                    @foreach ($pentaque2 as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{$item->keterangan }}</td>
                                            <td><span class="badge bg-success" style="font-size: 16px;">{{$item->pentaque_menang->nama_atlit }} ( Skor {{$item->skor_peserta1 }})</span></td>
                                            <td><span class="badge bg-info" style="font-size: 16px;">{{$item->pentaque_menang1->nama_atlit }} ( Skor {{$item->skor_peserta2 }})</span></td>
                                            @if(empty($item->id_peserta_menang_pentaque2 == ""))
                                            <td><span class="badge bg-danger" style="font-size: 16px;">{{$item->pentaque_menang2->nama_atlit }} (Skor {{$item->skor_peserta3 }})</span></td>
                                            @else
                                            <td>TIDAK ADA</p>
                                            @endif

                                            @if(empty($item->id_peserta_menang_pentaque3 == ""))
                                            <td><span class="badge bg-danger" style="font-size: 16px;">{{$item->pentaque_menang3->nama_atlit }} (Skor {{$item->skor_peserta4 }})</span></td>
                                            @else
                                            <td>TIDAK ADA</p>
                                            @endif
                                            <td>{{$item->status_pertandingan }}</td>
...
<div class="modal fade" role="dialog" id="imgmodal">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ route('savePentaqueSingle') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                        <label for="formGroupExampleInput2">Judul Series Pentaque</label>
